...
export default function ImportWorkoutPage() {
  ...
  return <PlanningShell eyebrow="PC nástroj" title="Import tréninku" description="Vlož strukturovaný JSON včetně cíle, RPE, tempa a sledovaných parametrů." backHref="/workouts">
