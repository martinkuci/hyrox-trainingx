  ...
  blocks: [
    {
      ...
      steps: [
        {
          id: "warmup-run-row",
          name: "5 min lehký běh nebo veslo",
          detail: "Klidné tempo",
        },
        {
          id: "warmup-mobility",
          name: "2 kola rozcvičení",
          detail: "Squat · lunge · push-up · plank",
        },
      ],
    },
    {
      ...
      steps: [
        { id: "run-600", name: "600 m běh", detail: "Tempo přibližně 75–80 %" },
        {
          ...
          name: "10 burpee broad jumps",
          detail: "Plynule a kontrolovaně",
        },
        {
          id: "walking-lunges",
          name: "16 walking lunges",
    ...
    },
    {
      ...
      steps: [
        {
          id: "cooldown-walk-stretch",
          name: "Vychození a protažení",
          detail: "3 minuty",
        },
      ],
    },
