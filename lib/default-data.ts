...
export const HYROX_02_TEMPLATE: WorkoutTemplate = {
  ...
  blocks: [
    { id: "hyrox-02-warmup", type: "manual", title: "Warm-up", repeat: 1, steps: [
    ...
    { id: "hyrox-02-main", type: "manual", title: "3 kola For Time", repeat: 3, steps: [
    ...
    { id: "hyrox-02-emom", type: "emom", title: "EMOM 6", minutes: 6, steps: [
      { id: "kb-swings", name: "12 kettlebell swings", detail: "Liché minuty" },
      { id: "box-step-overs", name: "10 box step-overs", detail: "Sudé minuty" },
    ] },
    { id: "hyrox-02-cooldown", type: "manual", title: "Cooldown", repeat: 1, steps: [
