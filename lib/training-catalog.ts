...
export const TRAINING_CATALOG_VERSION = 3;
...
export const HYROX_02_TEMPLATE = catalogTemplate({
  id: hyrox02,
  title: "Hybrid 02 · Mixed Foundation",
...
export const TRAINING_CATALOG: WorkoutTemplate[] = [
  ...
  catalogTemplate({
    ...
    description: "Kilometrové intervaly blízko cílového závodního tempa s plnou kontrolou každého úseku.",
    durationMinutes: 55,
    tags: ["běh", "1 km", "threshold", "závodní tempo"],
    code: "EGN-THR-02",
    category: "threshold",
    goal: "Najít udržitelné kilometrové tempo pro specifickou část přípravy.",
    rpe: [7, 8],
    expectedDuration: [48, 60],
    runningTarget: "Cílové závodní tempo nebo o 5–10 s/km rychleji, bez sprintu.",
  ...
  catalogTemplate({
    ...
    runningTarget: "Cílové závodní tempo; zpomalení mezi prvním a posledním během do 3 %.",
  ...
  catalogTemplate({
    ...
    description: "První polovina hybridní závodní simulace: čtyři kilometrové běhy a čtyři funkční disciplíny.",
    durationMinutes: 75,
  ...
  catalogTemplate({
    id: simulation03,
    title: "Race Simulation 03 · Full Distance",
    ...
    runningTarget: "Realistické cílové závodní tempo; první dva běhy záměrně konzervativně.",
    primaryMetric: "Celkový čas a stabilita osmi kilometrů",
    secondaryMetrics: ["přechodová zóna", "časy disciplín", "počet neplánovaných pauz"],
    progressionGroup: "race-simulation",
    difficultyLevel: 3,
    blocks: [
      ...
      manual(simulation03, "main", "Plný závodní formát", 1, [
  ...
  catalogTemplate({
    ...
    runningTarget: "Kontrolované cílové tempo; prvních 200 m po disciplíně bez sprintu.",
