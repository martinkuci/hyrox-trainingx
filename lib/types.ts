...
export type StepSplit = { blockId: string; stepId: string; round: number; durationSeconds: number };
...
export type NewWorkoutTemplate = Omit<WorkoutTemplate, "id" | "createdAt" | "updatedAt" | "tags"> & { tags?: string[] };
